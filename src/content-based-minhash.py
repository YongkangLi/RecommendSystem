...
# compute the jaccard similarity via MinHash
similarity = jaccard(np.array(minhash(tf_idf.T, 4)))
...
evaluate(pre, 8, users_mapping, items_mapping, '../result/content-based-minhash')
